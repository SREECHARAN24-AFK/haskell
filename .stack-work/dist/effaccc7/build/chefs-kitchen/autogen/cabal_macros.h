...
/* package chefs-kitchen-1.0.0 */
#ifndef VERSION_chefs_kitchen
#define VERSION_chefs_kitchen "1.0.0"
#endif /* VERSION_chefs_kitchen */
#ifndef MIN_VERSION_chefs_kitchen
#define MIN_VERSION_chefs_kitchen(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_chefs_kitchen */
...
#define CURRENT_COMPONENT_ID "chefs-kitchen-1.0.0-1miQ9ogTRzsJu3iQhziMvt-chefs-kitchen"
